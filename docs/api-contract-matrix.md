...
|---|---|---|---|---|---|
| Assignment | `GetAllocatedMaterials` | GET `api/Assignment/{assignmentId:guid}/allocated-materials` | inferred | `List<AllocatedMaterialDto>` | `Roles=Admin,Lead,QC,Staff` |
...
| Assignment | `GetAssignmentHistoryForQCAsync` | GET `api/Assignment/qc-lead-admin/assign-history/{batchId}` | inferred | `List<AssignmentHistoryDTO>` | `Roles=QC,Admin,Lead` |
...
| AssignmentTransferRequest | `GetReconciliationSummary` | GET `api/AssignmentTransferRequest/{assignmentId:guid}/reconcilliation-summary` | inferred | `ReconcilationSummaryDTO` | `Roles=Admin,Lead,QC,QCTransport,Staff` |
| AssignmentTransferRequest | `GetTransferRequestByAssignmentId` | GET `api/AssignmentTransferRequest/by-assignment/{assignmentId:guid}` | inferred | `TransferRequestDTO` | `Roles=Admin,Lead,QC,QCTransport,Staff` |
...
| Batch | `GetAllBatch` | GET `api/Batch` | none | `List<Batch>` | `Roles=Admin,Lead,QC,Staff` |
| Batch | `GetBatchForManagement` | GET `api/Batch/management` | none | `List<BatchDTO>` | `Policy=Admin` |
| Batch | `GetBatchById` | GET `api/Batch/{batchId:guid}` | inferred | `BatchDetailResponseDTO` | `Roles=Admin,Lead,QC,Staff` |
...
| Evaluate | `GetAll` | GET `api/Evaluate` | none | `List<EvaluateDTO>` | `Roles=Admin,Lead,QC,Staff` |
...
| Inventory | `GetInventoryByMaterialId` | GET `api/Inventory/from-{materialId:guid}` | query | `InventoryHistoryDTO` | `Roles=Admin,Lead` |
...
| Material | `GetAllMaterialsAsync` | GET `api/Material` | none | `List<MaterialToWatchDTO>` | `Roles=Admin,Lead,QC,Staff` |
| Material | `GetAllAsync` | GET `api/Material/all` | query | `List<MaterialDTO>` | `Roles=Admin,Lead,QC,Staff` |
| Material | `CreateMaterial` | POST `api/Material` | body | `IActionResult` | `Roles=Admin,Lead` |
| MaterialRequest | `GetAllRequest` | GET `api/MaterialRequest` | none | `IActionResult` | `Roles=Admin,Lead,QC,QCTransport,Staff` |
...
| MaterialRequest | `GetForAssignmentDashboard` | GET `api/MaterialRequest/assignment-dashboard` | query | `List<MaterialRequestForAssignmentDashboardDTO>` | `Roles=Lead,QC,Staff` |
...
| MaterialRequest | `ConfirmMaterialRequest` | PUT `api/MaterialRequest/confirmed/{id:guid}` | body | `IActionResult` | `Roles=QC,Lead` |
...
| MaterialSupply | `GetAllAsync` | GET `api/MaterialSupply` | query | `Result<List<MaterialSupplyDTO>>` | `Roles=Admin,Lead,QC,QCTransport` |
...
| MaterialSupply | `UpdateCompletedAsync` | PUT `api/MaterialSupply/qc/Completed/{supplyId}` | inferred | `IActionResult` | `Roles=QC` |
...
| MaterialWorkshop | `GetAllAsync` | GET `api/MaterialWorkshop/all` | query | `List<MaterialWorkshop>` | `Roles=Admin,Lead,QC` |
| MaterialWorkshop | `GetByQCIdAsync` | GET `api/MaterialWorkshop/for-qc` | query | `List<MaterialWorkshopDTO>` | `Policy=QC` |
| MaterialWorkshop | `GetTotalQuantityReceive` | GET `api/MaterialWorkshop/total-quantity-receive` | query | `int` | `Roles=QC,Lead` |
...
| Product | `GetAllProduct` | GET `api/Product` | none | `List<ProductsDTO>` | `Roles=Admin,Lead,QC,Staff` |
...
| Production | `GetAllAsync` | GET `api/production/all` | none | `List<ProductionDTO>` | `Roles=Admin,Lead,QC` |
...
| Production | `UpdateQuantity` | PUT `api/production/for-qc/reduce-quantity` | query | `IActionResult` | `Roles=QC` |
...
| ReworkRequest | `GetReworkRequestById` | GET `api/ReworkRequest/{reworkRequestId:guid}` | inferred | `Domain.Entities.ReworkRequest` | `Roles=Lead,QC,Staff` |
| ReworkRequest | `GetReworkReconciliationSummary` | GET `api/ReworkRequest/{assignmentId:guid}/summary` | inferred | `ReconcilationSummaryDTO` | `Roles=Lead,QC,Staff` |
| ReworkRequest | `GetByAssignId` | GET `api/ReworkRequest/by-assignId` | query | `Domain.Entities.ReworkRequest` | `Roles=Lead,QC,Staff` |
| ReworkRequest | `GetReworkForDashboard` | GET `api/ReworkRequest/{assignId:guid}/for-dashboard` | inferred | `ReworkRequestDTO` | `Roles=Lead,QC,Staff` |
...
| TaskTransferRequest | `GetById` | GET `api/TaskTransferRequest/materialRequestId-assignmentTransferId` | query | `TaskTransferRequestDTO` | `Roles=Admin,Lead,QC,QCTransport` |
| TaskTransferRequest | `GetByQcTransportAsync` | GET `api/TaskTransferRequest/for-QcTransport` | query | `List<TaskTransferRequestDTO>` | UNMARKED; authorization is commented |
...
| Workshop | `GetWorkshopsTemplate` | GET `api/Workshop` | none | `List<WorkshopsDTO>` | `Roles=Admin,Lead,QC,Staff` |
...
| WorkshopInventory | `GetAllWorkshopInventory` | GET `api/WorkshopInventory` | none | `List<Domain.Entities.WorkshopInventory>` | `Roles=Admin,Lead` |
| WorkshopInventory | `GetWorkshopInvenntoryByWorkshopId` | GET `api/WorkshopInventory/{workshopId:guid}` | inferred | `List<WorkshopInventoryForExportDTO>` | `Roles=Admin,Lead` |
...
| WorkshopInventory | `GetByMaterialId` | GET `api/WorkshopInventory/by-material` | query | `Domain.Entities.WorkshopInventory` | `Roles=Admin,Lead,QC,Staff` |
...
- Batch/Rework/Inventory/MaterialWorkshop/WorkshopInventory entity responses remain compatibility-sensitive and are scheduled for feature-by-feature DTO migration.
