...
namespace Application.Features.AssignmentTransferRequest.Commands.UpdateAssignmentTransferRequest
{
    public class UpdateAssignmentTransferRequestCommandHandler : IRequestHandler<UpdateAssignmentTransferRequestCommand, Result>
    {
        ...
        public UpdateAssignmentTransferRequestCommandHandler(IAssignmentRepository assignmentRepository, IAssignmentTransferRequestRepository assignmentTransferRequestRepository, IBatchRepository batchRepository, IAppDbContext appDbContext,
