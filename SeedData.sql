...
('B2C3D4E5-F6A7-4B5C-9D1E-2F3A4B5C6D7E', 'F6A7B8C9-D1E2-4F5A-4B5C-6D7E8F9A1B2C', 'Manager', N'Trần Thị Bình', 'manager@company.com', 'hashed_password_2', '0902345678', 'Active', GETDATE()),
('C3D4E5F6-A7B8-4C5D-1E2F-3A4B5C6D7E8F', 'F6A7B8C9-D1E2-4F5A-4B5C-6D7E8F9A1B2C', 'Worker', N'Lê Văn Cường', 'worker1@company.com', 'hashed_password_3', '0903456789', 'Active', GETDATE()),
('D4E5F6A7-B8C9-4D5E-2F3A-4B5C6D7E8F9A', 'A7B8C9D1-E2F3-4A5B-5C6D-7E8F9A1B2C3D', 'Worker', N'Phạm Thị Dung', 'worker2@company.com', 'hashed_password_4', '0904567890', 'Active', GETDATE()),
...
VALUES 
('C9D1E2F3-A4B5-4C5D-7E8F-9A1B2C3D4E5F', 'C3D4E5F6-A7B8-4C5D-1E2F-3A4B5C6D7E8F', N'Chào mừng', N'Chào mừng bạn đến với hệ thống sản xuất', N'System', GETDATE()),
('D1E2F3A4-B5C6-4D5E-8F9A-1B2C3D4E5F6A', 'C3D4E5F6-A7B8-4C5D-1E2F-3A4B5C6D7E8F', N'Nhiệm vụ mới', N'Bạn có nhiệm vụ sản xuất lô BATCH-2024-001', N'Task', GETDATE()),
('E2F3A4B5-C6D7-4E5F-9A1B-2C3D4E5F6A7B', 'D4E5F6A7-B8C9-4D5E-2F3A-4B5C6D7E8F9A', N'Nhiệm vụ mới', N'Bạn có nhiệm vụ lắp ráp tại xưởng lắp ráp', N'Task', GETDATE()),
('F3A4B5C6-D7E8-4F5A-1B2C-3D4E5F6A7B8C', 'E5F6A7B8-C9D1-4E5F-3A4B-5C6D7E8F9A1B', N'Yêu cầu kiểm tra', N'Có sản phẩm mới cần kiểm tra chất lượng', N'QC', GETDATE()),
('A4B5C6D7-E8F9-4A5B-2C3D-4E5F6A7B8C9D', 'B2C3D4E5-F6A7-4B5C-9D1E-2F3A4B5C6D7E', N'Báo cáo tuần', N'Vui lòng nộp báo cáo sản xuất tuần này', N'Report', GETDATE());
...
INSERT INTO MaterialRequests (Id, MaterialId, UserId, BatchId, QuantityRequest, Status, Note, Date)
VALUES 
('D4E5F6A7-B8C9-4D5E-2F3A-4B5C6D7E8F9A', 'F3A4B5C6-D7E8-4F5A-1B2C-3D4E5F6A7B8C', 'E5F6A7B8-C9D1-4E5F-3A4B-5C6D7E8F9A1B', 'A1B2C3D4-E5F6-4A5B-8C9D-1E2F3A4B5C6D', 500, N'Đã duyệt', N'Cần gấp', '2024-10-01'),
('E5F6A7B8-C9D1-4E5F-3A4B-5C6D7E8F9A1B', 'A4B5C6D7-E8F9-4A5B-2C3D-4E5F6A7B8C9D', 'E5F6A7B8-C9D1-4E5F-3A4B-5C6D7E8F9A1B', 'A1B2C3D4-E5F6-4A5B-8C9D-1E2F3A4B5C6D', 1000, N'Đã duyệt', N'Đơn thường', '2024-10-01'),
('F6A7B8C9-D1E2-4F5A-4B5C-6D7E8F9A1B2C', 'B5C6D7E8-F9A1-4B5C-3D4E-5F6A7B8C9D1E', 'E5F6A7B8-C9D1-4E5F-3A4B-5C6D7E8F9A1B', 'B2C3D4E5-F6A7-4B5C-9D1E-2F3A4B5C6D7E', 50, N'Chờ duyệt', N'Cho lô sơn', '2024-10-05');

-- INSERT dữ liệu cho bảng Inventory (Kho)
INSERT INTO [Inventories] (Id, MaterialId, Quantity, Date)
VALUES 
('A7B8C9D1-E2F3-4A5B-5C6D-7E8F9A1B2C3D', 'F3A4B5C6-D7E8-4F5A-1B2C-3D4E5F6A7B8C', 800, GETDATE()),
('B8C9D1E2-F3A4-4B5C-6D7E-8F9A1B2C3D4E', 'A4B5C6D7-E8F9-4A5B-2C3D-4E5F6A7B8C9D', 4500, GETDATE()),
('C9D1E2F3-A4B5-4C5D-7E8F-9A1B2C3D4E5F', 'B5C6D7E8-F9A1-4B5C-3D4E-5F6A7B8C9D1E', 180, GETDATE()),
('D1E2F3A4-B5C6-4D5E-8F9A-1B2C3D4E5F6A', 'C6D7E8F9-A1B2-4C5D-4E5F-6A7B8C9D1E2F', 450, GETDATE()),
('E2F3A4B5-C6D7-4E5F-9A1B-2C3D4E5F6A7B', 'D7E8F9A1-B2C3-4D5E-5F6A-7B8C9D1E2F3A', 120, GETDATE()),
('F3A4B5C6-D7E8-4F5A-1B2C-3D4E5F6A7B8C', 'E8F9A1B2-C3D4-4E5F-6A7B-8C9D1E2F3A4B', 280, GETDATE());

-- INSERT dữ liệu cho bảng MaterialUse (VL sử dụng theo lô)
INSERT INTO [MaterialUse] (Id, MaterialId, BatchId, AssignId, QuantityUsed, QuantityRemaining, Date)
VALUES 
('A7B8C9D1-E2F3-4A5B-5C6D-7E8F9A1B2C3D', 'F3A4B5C6-D7E8-4F5A-1B2C-3D4E5F6A7B8C', 'A1B2C3D4-E5F6-4A5B-8C9D-1E2F3A4B5C6D', 'E2F3A4B5-C6D7-4E5F-9A1B-2C3D4E5F6A7B', 200, 600, GETDATE()),
('B8C9D1E2-F3A4-4B5C-6D7E-8F9A1B2C3D4E', 'A4B5C6D7-E8F9-4A5B-2C3D-4E5F6A7B8C9D', 'A1B2C3D4-E5F6-4A5B-8C9D-1E2F3A4B5C6D', 'E2F3A4B5-C6D7-4E5F-9A1B-2C3D4E5F6A7B', 500, 4000, GETDATE()),
('C9D1E2F3-A4B5-4C5D-7E8F-9A1B2C3D4E5F', 'B5C6D7E8-F9A1-4B5C-3D4E-5F6A7B8C9D1E', 'B2C3D4E5-F6A7-4B5C-9D1E-2F3A4B5C6D7E', 'F3A4B5C6-D7E8-4F5A-1B2C-3D4E5F6A7B8C', 20, 160, GETDATE()),
('D1E2F3A4-B5C6-4D5E-8F9A-1B2C3D4E5F6A', 'C6D7E8F9-A1B2-4C5D-4E5F-6A7B8C9D1E2F', 'C3D4E5F6-A7B8-4C5D-1E2F-3A4B5C6D7E8F', 'A4B5C6D7-E8F9-4A5B-2C3D-4E5F6A7B8C9D', 50, 400, GETDATE()),
('E2F3A4B5-C6D7-4E5F-9A1B-2C3D4E5F6A7B', 'D7E8F9A1-B2C3-4D5E-5F6A-7B8C9D1E2F3A', 'D4E5F6A7-B8C9-4D5E-2F3A-4B5C6D7E8F9A', 'B5C6D7E8-F9A1-4B5C-3D4E-5F6A7B8C9D1E', 40, 80, GETDATE());
...
INSERT INTO [Productions] (Id, AssignId, UserId, Quantity, Date, Status, BatchId)
VALUES 
('C6D7E8F9-A1B2-4C5D-4E5F-6A7B8C9D1E2F', 'E2F3A4B5-C6D7-4E5F-9A1B-2C3D4E5F6A7B', 'C3D4E5F6-A7B8-4C5D-1E2F-3A4B5C6D7E8F', 50, '2024-10-05', N'Đã kiểm tra', 'A1B2C3D4-E5F6-4A5B-8C9D-1E2F3A4B5C6D'),
('D7E8F9A1-B2C3-4D5E-5F6A-7B8C9D1E2F3A', 'F3A4B5C6-D7E8-4F5A-1B2C-3D4E5F6A7B8C', 'D4E5F6A7-B8C9-4D5E-2F3A-4B5C6D7E8F9A', 25, '2024-10-08', N'Đã kiểm tra', 'B2C3D4E5-F6A7-4B5C-9D1E-2F3A4B5C6D7E'),
('E8F9A1B2-C3D4-4E5F-6A7B-8C9D1E2F3A4B', 'E2F3A4B5-C6D7-4E5F-9A1B-2C3D4E5F6A7B', 'C3D4E5F6-A7B8-4C5D-1E2F-3A4B5C6D7E8F', 30, '2024-10-09', N'Chờ kiểm tra', 'A1B2C3D4-E5F6-4A5B-8C9D-1E2F3A4B5C6D'),
('F9A1B2C3-D4E5-4F5A-7B8C-9D1E2F3A4B5C', 'F3A4B5C6-D7E8-4F5A-1B2C-3D4E5F6A7B8C', 'D4E5F6A7-B8C9-4D5E-2F3A-4B5C6D7E8F9A', 20, '2024-10-10', N'Đã kiểm tra', 'B2C3D4E5-F6A7-4B5C-9D1E-2F3A4B5C6D7E'),
('A1B2C3D4-E5F6-4A5B-8C9D-3E3F3A3B3C3D', 'E2F3A4B5-C6D7-4E5F-9A1B-2C3D4E5F6A7B', 'C3D4E5F6-A7B8-4C5D-1E2F-3A4B5C6D7E8F', 20, '2024-10-06', N'Chờ kiểm tra', 'A1B2C3D4-E5F6-4A5B-8C9D-1E2F3A4B5C6D');

-- INSERT dữ liệu cho bảng Evaluate (QC check)
INSERT INTO [Evaluates] (Id, ProductionId, UserId, Status, Note, Image, CreatedAt, BatchId)
VALUES 
('F9A1B2C3-D4E5-4F5A-7B8C-9D1E2F3A4B5C', 'C6D7E8F9-A1B2-4C5D-4E5F-6A7B8C9D1E2F', 'E5F6A7B8-C9D1-4E5F-3A4B-5C6D7E8F9A1B', N'Đạt', N'Chất lượng nón tốt, bề mặt nhẵn', N'/images/qc/qc_001.jpg', GETDATE(), 'A1B2C3D4-E5F6-4A5B-8C9D-1E2F3A4B5C6D'),
('A1B2C3D4-E5F6-4A5B-8C9D-0E0F0A0B0C0D', 'D7E8F9A1-B2C3-4D5E-5F6A-7B8C9D1E2F3A', 'E5F6A7B8-C9D1-4E5F-3A4B-5C6D7E8F9A1B', N'Đạt', N'Nón fullface đạt tiêu chuẩn, khóa cài tốt', N'/images/qc/qc_002.jpg', GETDATE(), 'B2C3D4E5-F6A7-4B5C-9D1E-2F3A4B5C6D7E'),
('B2C3D4E5-F6A7-4B5C-9D1E-0F0A0B0C0D0E', 'F9A1B2C3-D4E5-4F5A-7B8C-9D1E2F3A4B5C', 'E5F6A7B8-C9D1-4E5F-3A4B-5C6D7E8F9A1B', N'Đạt', N'Sản phẩm đạt yêu cầu, không có lỗi', N'/images/qc/qc_003.jpg', GETDATE(), 'B2C3D4E5-F6A7-4B5C-9D1E-2F3A4B5C6D7E');

-- INSERT dữ liệu cho bảng ComponentDefect (QC check)
INSERT INTO [ComponentDefects] (Id, EvaluateId, DefectType, Serverity, Description, Solution, CreatedAt, Status)
VALUES 
('B2C3D4E5-F6A7-4B5C-9D1E-0F0A0B0C0D0E', 'F9A1B2C3-D4E5-4F5A-7B8C-9D1E2F3A4B5C', N'Vết xước nhỏ', N'Thấp', N'Vết xước nhỏ trên bề mặt vỏ nón', N'Đánh bóng lại bề mặt', GETDATE(), N'Đã xử lý'),
('C3D4E5F6-A7B8-4C5D-1E2F-0A0B0C0D0E0F', 'A1B2C3D4-E5F6-4A5B-8C9D-0E0F0A0B0C0D', N'Khóa cài lỏng', N'Trung bình', N'Khóa cài có độ lỏng nhẹ', N'Điều chỉnh lại khóa cài', GETDATE(), N'Đã xử lý'),
('D4E5F6A7-B8C9-4D5E-2F3A-0B0C0D0E0F0A', 'F9A1B2C3-D4E5-4F5A-7B8C-9D1E2F3A4B5C', N'Màu sơn không đều', N'Thấp', N'Màu sơn có chỗ đậm nhạt không đồng đều', N'Sơn lại lớp hoàn thiện', GETDATE(), N'Đang xử lý'),
('E5F6A7B8-C9D1-4E5F-3A4B-0C0D0E0F0A0B', 'A1B2C3D4-E5F6-4A5B-8C9D-0E0F0A0B0C0D', N'Mút xốp lệch vị trí', N'Cao', N'Mút xốp lót không đúng vị trí thiết kế', N'Tháo ra và lắp lại đúng vị trí', GETDATE(), N'Đã xử lý');