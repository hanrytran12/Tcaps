...
VALUES 
    ...
    ('F3A4B5C6-D7E8-4F5A-1B2C-3D4E5F6A7B8C', 'B2C3D4E5-F6A7-4B5C-9D1E-2F3A4B5C6D7E', 'A7B8C9D1-E2F3-4A5B-5C6D-7E8F9A1B2C3D', 2, 50, 30000, '2024-10-05', '2024-10-15', '2024-10-18', 1, N'Pending', GETDATE()),
    ('A4B5C6D7-E8F9-4A5B-2C3D-4E5F6A7B8C9D', 'A1B2C3D4-E5F6-4A5B-8C9D-1E2F3A4B5C6D', 'B8C9D1E2-F3A4-4B5C-6D7E-8F9A1B2C3D4E', 3, 100, 22000, '2024-10-11', '2024-10-15', '2024-10-17', 1, N'Pending', GETDATE()),
    ('B5C6D7E8-F9A1-4B5C-3D4E-5F6A7B8C9D1E', 'C3D4E5F6-A7B8-4C5D-1E2F-3A4B5C6D7E8F', 'F6A7B8C9-D1E2-4F5A-4B5C-6D7E8F9A1B2C', 4, 150, 20000, '2024-10-10', '2024-10-22', '2024-10-25', 1, N'Pending', GETDATE()),
    ('C6D7E8F9-A1B2-4C5D-4E5F-6A7B8C9D1E2F', 'D4E5F6A7-B8C9-4D5E-2F3A-4B5C6D7E8F9A', 'A7B8C9D1-E2F3-4A5B-5C6D-7E8F9A1B2C3D', 5, 80, 27000, '2024-10-12', '2024-10-25', '2024-10-28', 1, N'Pending', GETDATE());
