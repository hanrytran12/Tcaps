...
(Id, MaterialId, BatchId, AssignId, QuantityDivide, QuantityStaffUse, QuantityRequest, Date)
VALUES 
('A7B8C9D1-E2F3-4A5B-5C6D-7E8F9A1B2C3D', 'F3A4B5C6-D7E8-4F5A-1B2C-3D4E5F6A7B8C', 'A1B2C3D4-E5F6-4A5B-8C9D-1E2F3A4B5C6D', 'E2F3A4B5-C6D7-4E5F-9A1B-2C3D4E5F6A7B', 800, 200, 1000, GETDATE()),
('B8C9D1E2-F3A4-4B5C-6D7E-8F9A1B2C3D4E', 'A4B5C6D7-E8F9-4A5B-2C3D-4E5F6A7B8C9D', 'A1B2C3D4-E5F6-4A5B-8C9D-1E2F3A4B5C6D', 'E2F3A4B5-C6D7-4E5F-9A1B-2C3D4E5F6A7B', 4500, 500, 5000, GETDATE()),
('C9D1E2F3-A4B5-4C5D-7E8F-9A1B2C3D4E5F', 'B5C6D7E8-F9A1-4B5C-3D4E-5F6A7B8C9D1E', 'B2C3D4E5-F6A7-4B5C-9D1E-2F3A4B5C6D7E', 'F3A4B5C6-D7E8-4F5A-1B2C-3D4E5F6A7B8C', 180, 20, 200, GETDATE()),
('D1E2F3A4-B5C6-4D5E-8F9A-1B2C3D4E5F6A', 'C6D7E8F9-A1B2-4C5D-4E5F-6A7B8C9D1E2F', 'C3D4E5F6-A7B8-4C5D-1E2F-3A4B5C6D7E8F', 'A4B5C6D7-E8F9-4A5B-2C3D-4E5F6A7B8C9D', 450, 50, 500, GETDATE()),
