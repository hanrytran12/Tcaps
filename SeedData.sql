...
('D0000000-0000-0000-0000-000000000001', 'C0000000-0000-0000-0000-000000000001', 'BATCH-2025-001', 100, '2025-11-01', '2025-11-15', GETDATE(), N'Đang sản xuất', 0),
-- Lô 2: NON-002, 50 cái, Đang sản xuất
('D0000000-0000-0000-0000-000000000002', 'C0000000-0000-0000-0000-000000000002', 'BATCH-2025-002', 50, '2025-11-05', '2025-11-20', GETDATE(), N'Đang sản xuất', 0),
-- Lô 3: NON-001, 150 cái, Chưa bắt đầu
('D0000000-0000-0000-0000-000000000003', 'C0000000-0000-0000-0000-000000000001', 'BATCH-2025-003', 150, '2025-11-10', '2025-11-25', GETDATE(), N'Chưa bắt đầu', 0),
-- Lô 4: NON-003, 80 cái, Chưa bắt đầu
('D0000000-0000-0000-0000-000000000004', 'C0000000-0000-0000-0000-000000000003', 'BATCH-2025-004', 80, '2025-11-12', '2025-11-28', GETDATE(), N'Chưa bắt đầu', 0),
-- Lô 5: NON-004, 120 cái, Hoàn thành
('D0000000-0000-0000-0000-000000000005', 'C0000000-0000-0000-0000-000000000004', 'BATCH-2025-005', 120, '2025-10-25', '2025-11-08', GETDATE(), N'Hoàn thành', 0);
...
('E0000000-0000-0000-0000-000000000001', 'D0000000-0000-0000-0000-000000000001', 'A1C9B3A0-4F12-4E81-B17B-000000000001', 1, 100, 10000, '2025-11-01', '2025-11-03', '2025-11-03', 1, N'Completed', GETDATE()),
...
('E0000000-0000-0000-0000-000000000003', 'D0000000-0000-0000-0000-000000000001', 'A1C9B3A0-4F12-4E81-B17B-000000000003', 3, 100, 20000, '2025-11-07', '2025-11-09', '2025-11-09', 1, N'Pending', GETDATE()),
-- Lô 1 (D001): Công đoạn 4 - Cắt vải ra đủ bộ
('E0000000-0000-0000-0000-000000000004', 'D0000000-0000-0000-0000-000000000001', 'A1C9B3A0-4F12-4E81-B17B-000000000004', 4, 100, 12000, '2025-11-10', '2025-11-12', '2025-11-12', 0, N'Pending', GETDATE()),

-- Lô 2 (D002): Công đoạn 1 - Cắt laser
('E0000000-0000-0000-0000-000000000005', 'D0000000-0000-0000-0000-000000000002', 'A1C9B3A0-4F12-4E81-B17B-000000000001', 1, 50, 10000, '2025-11-05', '2025-11-07', '2025-11-07', 1, N'Completed', GETDATE()),
-- Lô 2 (D002): Công đoạn 2 - Cắt vải ép keo
('E0000000-0000-0000-0000-000000000006', 'D0000000-0000-0000-0000-000000000002', 'A1C9B3A0-4F12-4E81-B17B-000000000002', 2, 50, 15000, '2025-11-08', '2025-11-10', '2025-11-10', 1, N'Pending', GETDATE()),

-- Lô 5 (D005): 
('E0000000-0000-0000-0000-000000000007', 'D0000000-0000-0000-0000-000000000005', 'A1C9B3A0-4F12-4E81-B17B-000000000003', 16, 120, 8000, '2025-11-06', '2025-11-08', '2025-11-08', 0, N'Completed', GETDATE());
...
('F0000000-0000-0000-0000-000000000001', 'B0000000-0000-0000-0000-000000000001', 'A0000000-0000-0000-0000-000000000003', 'D0000000-0000-0000-0000-000000000001', 'E0000000-0000-0000-0000-000000000001', 200, N'Đã duyệt', N'Cần gấp cho công đoạn cắt laser', '2025-11-01'),
-- Staff worker1 yêu cầu keo dán cho Lô 1, Assignment 2
('F0000000-0000-0000-0000-000000000002', 'B0000000-0000-0000-0000-000000000004', 'A0000000-0000-0000-0000-000000000003', 'D0000000-0000-0000-0000-000000000001', 'E0000000-0000-0000-0000-000000000002', 50, N'Đã duyệt', N'Keo ép vải', '2025-11-04'),
-- Staff worker2 yêu cầu sợi nylon cho Lô 2, Assignment 5
('F0000000-0000-0000-0000-000000000003', 'B0000000-0000-0000-0000-000000000002', 'A0000000-0000-0000-0000-000000000004', 'D0000000-0000-0000-0000-000000000002', 'E0000000-0000-0000-0000-000000000005', 100, N'Chờ duyệt', N'Sợi nylon cho fullface', '2025-11-05');
...
('40000000-0000-0000-0000-000000000004', 'E0000000-0000-0000-0000-000000000007', 'A0000000-0000-0000-0000-000000000004', 120, '2025-11-08', N'Đã kiểm tra');
